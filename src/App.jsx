...
function History({ history, setHistory, customers, services, employees, authUser, canManage = false }) {
  return canManage
    ? <HistoryManagement {...{ history, setHistory, customers, services, employees, authUser }} />
...
function HistoryManagementDetail({ record, setHistory, close, customers, services, employees, authUser }) {
  ...
  const interactionBlocked = concurrentChange || recordFingerprint !== acceptedFingerprintRef.current
  useEffect(() => {
    const frame = requestAnimationFrame(() => {
...
function Accounts({ customers, setCustomers, setNotice, ask, history, teams, weekly, permissions = {}, isAdministrator = false, stateRevision, refreshRemoteState }) {
