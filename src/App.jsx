...
import { countYearToDateAlarmInstallations, countYearToDateCompletedRecords, dashboardPendingGroups } from './domain/dashboard/dashboard-metrics.mjs'
...
function History({ history, setHistory, customers, services, employees, authUser, canManage = false, persistHistoryRecord, persistHistoryRecordRemoval }) {
