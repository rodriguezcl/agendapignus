...
function History({ history, setHistory, customers, services, employees, authUser, canManage = false, persistHistoryRecord, persistHistoryRecordRemoval, initialFilter = null }) {
  ...
  return <>{canManage
    ? <HistoryManagement {...{ history, setHistory, customers, services, employees, authUser, persistHistoryRecord, persistHistoryRecordRemoval, reminderFilter, clearReminderFilter }} />
...
function HistoryBulkView({ history, setHistory, customers, services, employees, authUser, persistHistoryRecord, persistHistoryRecordRemoval, reminderFilter = null, clearReminderFilter = () => {} }) {
  const [search, setSearch] = useState('')
  const [detail, setDetail] = useState(null)
...
function HistoryManagementDetail({ record, setHistory, close, customers, services, employees, authUser, persistHistoryRecord, persistHistoryRecordRemoval }) {
