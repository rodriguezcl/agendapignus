...
<div className="daily-field-duration"><ServiceEstimatedDurationField value={serviceEstimateForTask(task, serviceForTask(task))} onChange={estimatedMinutes => updateTask(teamIndex, taskIndex, { estimatedMinutes, estimatedMinutesCustomized: true })} /><ServiceJourneys record={historyRecordForTask(task, date, history)} disabled={dailyServiceHasChanges(task)} /></div>
