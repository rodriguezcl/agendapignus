...
function TechnicianPortal({ user, history, setHistory, logout, sessionInvalidated }) {
  ...
  useEffect(() => {
    ...
    if (help) help.textContent = view === 'agenda' ? 'Completá los servicios en domicilio en el orden indicado. Los controles vehiculares son tareas autónomas y se habilitan únicamente al llegar su propia fecha y hora.' : 'Consultá los servicios que ya informaste y el estado registrado en cada uno.'
  }, [view])
  useEffect(() => {
