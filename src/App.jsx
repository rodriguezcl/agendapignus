...
function Agenda({ date, setDate, teams, setTeams, activeTechs, customers, services, history, setHistory, updateTask, setNotice }) {
  ...
  return <AgendaLayout {...{ date, setDate, teams, setTeams, activeTechs, customers, services, history, setHistory, updateTask, setNotice }} />
...
function AgendaLayout({ date, setDate, teams, setTeams, activeTechs, customers, services, history, setHistory, updateTask, setNotice }) {
  return <AgendaWorkspace {...{ date, setDate, teams, setTeams, activeTechs, customers, services, history, setHistory, updateTask, setNotice }} />
...
function AgendaWorkspace({ date, setDate, teams, setTeams, activeTechs, customers, services, history, setHistory, updateTask, setNotice }) {
  return <AgendaWorkspaceForm {...{ date, setDate, teams, setTeams, activeTechs, customers, services, history, setHistory, updateTask, setNotice }} />
  const [preview, setPreview] = useState(false)
  const [techOpen, setTechOpen] = useState(null)
  const [filter, setFilter] = useState('')
  const [confirmation, setConfirmation] = useState(null)
