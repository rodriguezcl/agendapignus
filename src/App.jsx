...
const blankTask = () => ({ taskId: createTaskId(), time: '', serviceId: '', service: '', customerId: '', client: '', clientAccount: '', clientNameAtService: '', address: '', phone: '', detail: '', internalNote: '', internalChecklist: [], paymentMethod: '', amount: '', monthlyFee: '', form: '' })
...
function HistoricalServiceFields({ pastService }) {
  return <>{[
      ...
      ['Pago y documentación', [
        ['Forma de pago', pastService.paymentMethod], ['Monto', formatCurrencyAmount(pastService.amount)], ['Abono mensual', formatCurrencyAmount(pastService.monthlyFee)], ['Formulario', pastService.form]
      ]],
