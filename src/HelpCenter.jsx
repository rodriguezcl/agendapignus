...
const MODULES = [
  ...
  },
  {
    ...
    articles: [
      { title: 'Elegir la semana', body: 'Seleccioná una fecha en Semana de trabajo. La vista se posiciona en el día actual cuando corresponde, pero las barras superior e inferior permiten consultar días anteriores y posteriores. Cada trabajo reserva su tiempo estimado y no puede superponerse con otro del mismo equipo. Los trabajos breves conservan una reserva operativa mínima de 60 minutos; los turnos predeterminados vacíos que choquen con una franja ocupada dejan de mostrarse automáticamente.' },
  ...
  },
  {
    ...
    articles: [
      { title: 'Cargar la agenda de una fecha', body: 'Elegí la fecha de trabajo. La agenda carga la planificación semanal y los servicios reprogramados de ese día. Podés agregar trabajos de último momento sin perder los ya registrados. Los domingos permanecen bloqueados por ser días no operativos. Si es feriado, primero debe existir una definición de Día laboral; cuando se define como Día no operativo tampoco admite equipos, técnicos ni servicios.' },
  ...
  },
  {
    ...
    articles: [
      { title: 'Servicios asignados', body: 'Agenda técnica muestra los servicios pendientes de hoy y mañana, evitando acumular en pantalla los controles y trabajos del resto del mes. Los trabajos en domicilio deben resolverse en el orden indicado: la dirección y el contacto del siguiente se habilitan después de informar el estado del servicio actual. Los controles vehiculares son tareas autónomas: no poseen dirección ni contacto, no muestran avisos de desbloqueo y se habilitan para completar desde su propia fecha y hora. Si el viernes es un feriado definido como no operativo, el control pasa automáticamente al último día operativo anterior, incluso ante feriados consecutivos. Como excepción, un control vehicular vencido permanece visible; los demás trabajos en domicilio pueden consultarse, pero sus domicilios y contactos permanecen ocultos hasta completar ese control.' },
      { title: 'Marcar un servicio como completado', steps: ['Presioná Marcar completado.', 'Cargá una observación técnica si puede servir en futuras visitas.', 'Presioná Continuar.', 'Revisá el mensaje de confirmación y elegí Sí, confirmar estado.'], note: 'Sólo puede completarse desde su fecha y hora programadas. Al confirmar se registra la hora real y, si terminó antes de lo previsto, la agenda libera al equipo desde el siguiente cuarto de hora. La observación es opcional al completar, pero es obligatoria al solicitar una reprogramación o informar una cancelación.' },
