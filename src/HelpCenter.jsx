...
const MODULES = [
  ...
  },
  {
    ...
    articles: [
      ...
      { title: 'Guardias de los sábados', body: 'Desde Guardias del año, un administrador define el orden de rotación de los técnicos. El ciclo comienza el primer sábado y se repite automáticamente durante todo el año. Cada sábado puede corregirse manualmente como excepción sin alterar el orden general. Si el técnico de guardia recibe un servicio el viernes entre las 16:00 y las 20:00, el sistema interpreta que adelantó su guardia: bloquea cualquier nuevo equipo, técnico o servicio del sábado y muestra una leyenda informativa.' },
