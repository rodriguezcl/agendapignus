...
const MODULES = [
  ...
  },
  {
    ...
    articles: [
      ...
      { title: 'Reserva PIG o cliente nuevo', body: 'Si será un nuevo abonado y todavía no fue creado en SoftGuard, usá Reservar nuevo abonado. Cargá datos provisorios y vinculá después el PIG importado: no se crea ningún CLI residual y el turno conserva su identidad. Usá Agregar cliente CLI sólo para una persona que realmente será cliente sin abono. Para una cuenta existente, corregí sus datos desde Abonados y clientes.' },
