...
const MODULES = [
  ...
  },
  {
    ...
    articles: [
      { title: 'Elegir la semana', body: 'Seleccioná una fecha en Semana de trabajo. La vista se posiciona en el día actual cuando corresponde, pero las barras superior e inferior permiten consultar días anteriores y posteriores. Cada equipo debe tener al menos una hora entre servicios: si cargás un horario manual a menos de 60 minutos de un turno predeterminado todavía vacío, ese turno deja de mostrarse automáticamente.' },
