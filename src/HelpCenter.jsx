...
const MODULES = [
  ...
  },
  {
    ...
    articles: [
      ...
      { title: 'Definir equipos y horarios del mes', body: 'Al comenzar un mes, un administrador debe confirmar la composición desde Equipos del mes y luego establecer dos turnos desde Horarios del mes. Con cinco técnicos activos, el sistema propone tres equipos para los tres vehículos: dos duplas y un técnico que sale solo. La combinación rota durante cinco meses para que cada persona trabaje una vez con cada compañero y una vez individualmente; después el ciclo vuelve a comenzar. La sugerencia puede modificarse antes de guardarla y no altera agendas ya cargadas. Los horarios se aplican a los espacios vacíos del mes; los servicios existentes conservan su hora.' },
      { title: 'Asignar responsables de los vehículos', body: 'Desde Vehículos del mes, asigná un responsable diferente a cada unidad. El sistema propone el Ford Ka para el técnico que trabaja solo y genera automáticamente un control para cada viernes del mes a las 15:30 hs. Las asignaciones pueden modificarse antes de comenzar los controles.' },
