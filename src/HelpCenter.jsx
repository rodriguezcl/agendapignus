...
const MODULES = [
  ...
  },
  {
    ...
    articles: [
      ...
      { title: 'Completar un servicio', steps: ['Ingresá la hora.', 'Seleccioná el tipo de servicio.', 'Buscá y elegí el abonado o cliente.', 'Revisá dirección, contacto y observaciones.', 'Si es una instalación de alarma, elegí la ubicación y completá los datos adicionales habilitados.'], note: 'En Vista previa, Copiar agenda y la agenda técnica sólo se informa la forma de pago cuando es Efectivo —junto con el monto— y el Formulario cuando está Incompleto. El abono mensual y las demás opciones quedan para la gestión administrativa.' },
...
function HelpCenter({ onNavigate, isAdministrator }) {
  ...
  return <div className="help-center">
    <header className="help-hero">
      <div><p className="eyebrow">GUÍAS Y PREGUNTAS FRECUENTES</p><h1>Centro de ayuda</h1><span className="help-updated">Actualizado · 30 de agosto de 2026</span><p>Encontrá instrucciones simples para completar cada tarea con seguridad.</p></div>
