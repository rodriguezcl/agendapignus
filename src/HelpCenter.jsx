...
const MODULES = [
  ...
  },
  {
    ...
    articles: [
      ...
      { title: 'Aprovechar una finalización anticipada', body: 'Cuando un servicio de hoy se completa antes de su duración estimada, el equipo queda disponible desde el siguiente cuarto de hora. Podés agregar otro trabajo en esa ventana si su duración completa —incluida la reserva operativa mínima— termina antes del próximo servicio programado. La agenda muestra la hora real de finalización y desde cuándo quedó disponible el equipo.' },
  ...
  },
  {
    ...
    articles: [
      ...
      { title: 'Tiempo estimado por servicio', body: 'Cada tipo de servicio posee una duración predeterminada expresada en horas y minutos. Al elegirlo en Agenda semanal o Agenda del día, ese valor se copia al trabajo y puede ajustarse según la cantidad de equipos, el cableado u otra complejidad particular, sin modificar el catálogo ni otros servicios ya planificados.' },
